...
4. Provide the shared constructor a listing result calls, which validates order before a value is built, so an unordered page cannot exist as a Rust value.
