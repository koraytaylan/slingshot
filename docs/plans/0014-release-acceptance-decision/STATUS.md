...
- **Known tightness:** `crates/slingshot-development/src/release_acceptance.rs` is 993 lines against a 1,000-line ceiling, and `source-policy` is the first gate acceptance runs. The next task to add to that file splits it first.
