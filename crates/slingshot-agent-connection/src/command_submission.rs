...
/// # Errors
///
/// Returns [`SubmissionRefusal::AcknowledgementMalformed`] when the body is
/// not one acknowledgement this build can read.
...
#[path = "command_submission_settlement.rs"]
mod settlement;
pub use settlement::remaining_retention_milliseconds;
