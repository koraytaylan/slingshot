...
#[path = "operation_repository_admission.rs"]
mod admission;
#[path = "operation_repository_mutations.rs"]
mod mutations;
#[path = "operation_repository_recovery.rs"]
mod recovery;
...
impl OperationRepository {
    ...
    ///
    /// # Errors
    /// Returns [`RepositoryFailure`] if stored values cannot be decoded or the
    /// database refuses the transaction or retained-input query.
